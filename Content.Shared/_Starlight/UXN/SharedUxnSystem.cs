...
public abstract partial class SharedUxnSystem : EntitySystem
{
    ...
    private void OnExamineAttachable(Entity<UxnAttachableComponent> ent, ref ExaminedEvent args) => args.PushMarkup(Loc.GetString("uxn-attachable-component-examine"));
}
