...
public sealed partial class PathogenSymptomPrototype : IPrototype
{
    ...
    /// This is the main lever for making a strain ramp up rather than arrive fully formed.
    /// </summary>
    [DataField]
    ...
    /// <summary>
    /// Fraction of <see cref="Interval"/> to randomly vary each expression by.
    /// Without this, everyone infected by the same strain sneezes in unison, which
    /// reads as a bug rather than an outbreak.
    /// </summary>
    [DataField]
    public float IntervalVariance = 0.35f;

    /// <summary>
    /// How much stronger this gets per stage past <see cref="MinStage"/>.
    /// The effects are applied with scale 1 + (stage - 1) * this. Zero means flat.
    /// </summary>
    [DataField]
