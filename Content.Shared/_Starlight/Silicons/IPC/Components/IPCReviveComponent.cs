...
public sealed partial class IPCReviveComponent : Component
{
    ...
    [DataField]
    public DamageSpecifier DefibShockDamage = new()
    {
        DamageDict = new() { { "Shock", 50 } }
    };

    [DataField]
    public int DefibElectrocutionDamage = 125;

    [DataField]
    public TimeSpan DefibElectrocutionTime = TimeSpan.FromSeconds(5);
