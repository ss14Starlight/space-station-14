...
public sealed partial class ThievingSystem : EntitySystem
{
    ...
    private readonly TimeSpan AdminStripReduction = TimeSpan.FromSeconds(-1000); // Admins still need to be able to instant strip. Their time is 9999, but I've kept this at 9500 incase an admin somehow gets steal time reduced to 9998, and because there was actually a case where I wanted a stripTime of over 1000.
    //Starlight end
