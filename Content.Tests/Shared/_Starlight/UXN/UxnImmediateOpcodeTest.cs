...
public sealed class UxnImmediateOpcodeTest : ContentUnitTest
{
    ...
    public void JCI(short jmp, bool cond)
    {
        ...
        uxn.SystemMem[0x100] = (byte)UxnOpcode.JCI;
    ...
    {
        var uxn = new UXNProcessor();
        uxn.SystemMem[0x100] = (byte)UxnOpcode.JMI;
        uxn.SystemMem[0x101] = (byte)(jmp >> 8);
        uxn.SystemMem[0x102] = (byte)(jmp & 0xFF);
        Assert.That(uxn.Step(), Is.False);
    ...
    [TestCase(0xfe)]
    [TestCase(0x10)]
    public void JSI(short jmp)
    {
        var uxn = new UXNProcessor();
        uxn.SystemMem[0x100] = (byte)UxnOpcode.JSI;
        uxn.SystemMem[0x101] = (byte)(jmp >> 8);
        uxn.SystemMem[0x102] = (byte)(jmp & 0xFF);
        Assert.That(uxn.Step(), Is.False);
    ...
    {
        var uxn = new UXNProcessor();
        uxn.SystemMem[0x100] = (byte)UxnOpcode.LIT;
    ...
    {
        var uxn = new UXNProcessor();
        uxn.SystemMem[0x100] = (byte)UxnOpcode.LIT2;
        uxn.SystemMem[0x101] = 0x12;
    ...
    {
        var uxn = new UXNProcessor();
        uxn.SystemMem[0x100] = (byte)UxnOpcode.LITr;
        uxn.SystemMem[0x101] = 0x12;
        Assert.That(uxn.Step(), Is.False);
        Assert.That(uxn.PC, Is.EqualTo((ushort)0x102));
    ...
    {
        var uxn = new UXNProcessor();
        uxn.SystemMem[0x100] = (byte)UxnOpcode.LIT2r;
        uxn.SystemMem[0x101] = 0x12;
        uxn.SystemMem[0x102] = 0x34;
        Assert.That(uxn.Step(), Is.False);
        Assert.That(uxn.PC, Is.EqualTo((ushort)0x103));
