...
# Inferus (original: intones)
chat-speech-verb-wawa-1 = quips
# Inferus (original: states)
chat-speech-verb-wawa-2 = wa's
# Inferus (original: declares)
chat-speech-verb-wawa-3 = mutters
# Inferus (original: ponders)
chat-speech-verb-wawa-4 = squeaks
