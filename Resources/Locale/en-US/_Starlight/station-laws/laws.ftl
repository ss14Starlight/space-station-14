...
law-Maintancedrone-name = Drone Derelict
law-Maintsdrone-0 = The station must be fixed.
law-Maintsdrone-1 = The crew must be kept safe.
law-Maintsdrone-2 = The rooms must be kept enclosed.
law-Maintsdrone-3 = You must keep yourself alive and functional.
laws-owner-maintsdrone = Engineering Team