...
pathogen-protection-filter-mask = [color=yellow]Pathogen filter:[/color] partially filters inhaled pathogens without internals.
pathogen-protection-supply-mask = [color=yellow]Air-supply interface:[/color] protects from inhaled pathogens only while internals are working.
pathogen-protection-sterile-barrier = [color=yellow]Sterile barrier:[/color] reduces contact pathogen exposure.
pathogen-protection-bio-suit = [color=yellow]Bio suit:[/color] completely blocks contact pathogens and settling spores.
pathogen-protection-bio-hood = [color=yellow]Bio hood:[/color] completely seals the airway against pathogens.
pathogen-protection-sealed-suit = [color=yellow]Sealed outer suit:[/color] strongly reduces exposure to settling spores.
pathogen-protection-unknown = This item's pathogen protection cannot be identified.
...
pathogen-symptom-viral-sniffling = sniffling
pathogen-symptom-viral-watery-eyes = watery eyes
pathogen-symptom-bacterial-throat-clearing = throat clearing
pathogen-symptom-bacterial-throat-discomfort = throat discomfort
pathogen-symptom-fungal-scratching = skin irritation
pathogen-symptom-fungal-eye-rubbing = eye irritation
pathogen-symptom-fungal-skin-flaking = flaking skin
...
pathogen-symptom-ambient-fungal-harmless-rash = harmless fungal rash
...
pathogen-symptom-bacterial-throat-clearing-visible = {CAPITALIZE(THE($entity))} repeatedly clears their throat.
pathogen-symptom-bacterial-throat-discomfort-visible = {CAPITALIZE(THE($entity))} winces and rubs their throat.
pathogen-symptom-fungal-scratching-visible = {CAPITALIZE(THE($entity))} scratches irritably at their skin.
pathogen-symptom-fungal-eye-rubbing-visible = {CAPITALIZE(THE($entity))} rubs at their irritated eyes.
pathogen-symptom-fungal-skin-flaking-visible = {CAPITALIZE(THE($entity))} brushes flakes from their clothing.
...
pathogen-symptom-ambient-fungal-harmless-rash-popup = A patchy rash prickles across your skin.
