...
cosmiccult-rift-corpse10-warning = Station authorities are advised to increase focus on the detected nullspace energy source. Energy levels are continuing to rise.

cosmiccult-rift-corpse15-warning = Extremely dangerous nullspace energy levels detected. Immediate evacuation or emergency security assistance is advised.

cosmiccult-rift-corpse20-warning = Station authorities are advised to take drastic measures to neutralize the nullspace energy source. Failure to do so will result in the station being deemed condemned.
