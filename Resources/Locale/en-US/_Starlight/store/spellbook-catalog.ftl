...
spellbook-event-summon-cheese-description = Reach into the void and pluck out... a single piece of chese!

spellbook-event-tower-babel-name = Language Shift
spellbook-event-tower-babel-description = Can you Repeat that? Randomizes everthing's languages! Has to be cast on station. Disables refunds.
