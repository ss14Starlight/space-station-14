...
job-description-briglieutenant = Aid the Warden in their day-to-day tasks, process prisoners, do paperwork and manage unruly staff.
job-description-personnelliaison = Help out the Head of Personnel with their tasks, manage the staff in the Service department directly, do paperwork for Command and protect Ian.
job-description-principalengineer = Aid the Chief Engineer in whatever they ask of you, manage the staff of Engineering and do station repairs if needed.
job-description-executivenursingofficer = Report to the Chief Medical Officer, make sure people live and make sure your staff do too!
job-description-logisticsmanager = Help out the Quartermaster, make sure your subordinates are fulfilling orders, go on salvaging expeditions too if you really want!
job-description-researchcoordinator = Make sure that the staff in the Science department are being behaved, report to the Research Director and make sure everyhing doesn't explode!