thief-role-greeting-human =
    You are criminal scum, a kleptomaniac previously arrested and currently on parole for petty theft. You need to add more to your collection.
# Inferus change: rewrite thief
