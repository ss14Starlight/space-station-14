...
marking-LizardArmTiger-l_arm_tiger = Lizard Left Arm (Tiger)
marking-LizardArmTiger = Lizard Left Arm (Tiger)

marking-LizardLegTiger-l_leg_tiger = Lizard Left Leg (Tiger)
marking-LizardLegTiger = Lizard Left Leg (Tiger)

marking-LizardArmTiger-r_arm_tiger = Lizard Right Arm (Tiger)

marking-LizardLegTiger-r_leg_tiger = Lizard Right Leg (Tiger)
