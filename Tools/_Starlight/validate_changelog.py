...
# Check for valid tags (accepts both - and • as list markers)
valid_tags = ["add", "remove", "tweak", "fix"]
entry_pattern = re.compile(r'^[ \t]*[-•][ \t]+([a-z]+):', re.MULTILINE)
