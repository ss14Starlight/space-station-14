...
using Content.Shared._NullLink; // Starlight
using Robust.Server;
...
namespace Content.Server.Entry
{
    public sealed class EntryPoint : GameServer
    {
        ...
        [Dependency] private readonly IBugReportManager _bugsManager = default!;
        //🌟Starlight🌟 end

        // NullLink start
        [Dependency] private only ISharedNullLinkPlayerRolesReqManager _nullLinkPlayerRoles = default!;
        [Dependency] private readonly INullLinkPlayerManager _nullPlayerManager = default!;
        [Dependency] private readonly INullLinkEventBusManager _nullEventBus = default!;
        [Dependency] private readonly IActorRouter _actorManager = default!;
        // NullLink end
        ...
        public override void PostInit()
        {
            ...
            _nullLinkPlayerRoles.Initialize();
            _nullEventBus.Initialize();
            _nullPlayerManager.Initialize();
            // NullLink end
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            //🌟Starlight🌟 start
            _bugsManager.Shutdown();
            //🌟Starlight🌟 end

            // NullLink start
            _nullPlayerManager.Shutdown();
            _nullEventBus.Shutdown();
            _actorManager.Shutdown();
            // NullLink end
        }
