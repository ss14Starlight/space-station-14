...
public static class AdminBanExtensions
{
    ...
    public static ServerBanDef ToDef(this AdminBan ban)
        => new(ban.Id, ban.UserId == null ? null : new NetUserId(ban.UserId.Value), ParseAddress(ban.Address), ban.HWId == null ? null : new ImmutableTypedHwid(ban.HWId.Hwid.ToImmutableArray(), (HwidType)ban.HWId.Type), ban.BanTime, ban.ExpirationTime, ban.RoundId, ban.PlayTimeAtNote, ban.Reason ?? "", ParseSeverity(ban.Severity), ban.BanningAdmin == null ? null : new NetUserId(ban.BanningAdmin.Value), null, ban.ExemptFlags == null ? 0 : (ServerBanExemptFlags)ban.ExemptFlags.Value, ban.ProjectName, ban.ServerName, true);
