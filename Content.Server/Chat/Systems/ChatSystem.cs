...
public sealed partial class ChatSystem : SharedChatSystem
{
        ...
        )
    {
        ...
        bool shouldPunctuate = _configurationManager.GetCVar(StarlightCCVars.AutoPunctuate) || player != null && _netConfigManager.GetClientCVar(player.Channel, StarlightCCVars.AutoPunctuate); // Starlight
