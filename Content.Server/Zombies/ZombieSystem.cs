    ...
    public sealed partial class ZombieSystem : SharedZombieSystem
    {
        ...
        private void OnMeleeHit(Entity<ZombieComponent> entity, ref MeleeHitEvent args)
        {
            ...
            foreach (var uid in args.HitEntities)
            {
                ...
                if (HasComp<ZombieComponent>(uid) || HasComp<IncurableZombieComponent>(uid) || HasComp<InitialInfectedComponent>(entity)) // Starlight-edit: Zombies cannot attack initial infected
                {
