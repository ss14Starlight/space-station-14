...
public sealed class StationRecordsSystem : SharedStationRecordsSystem
{
        ...
        string? jobId, StationRecordsComponent records)
    {
        ...
        // Starlight End
        CreateGeneralRecord(station, idUid.Value, characterName, profile.Age, specie, profile.Gender, jobId, fingerprintComponent?.Fingerprint, dnaComponent?.DNA, profile, records); // Starlight Edited (profile.Species -> specie, profile.Name -> characterName)
    }
