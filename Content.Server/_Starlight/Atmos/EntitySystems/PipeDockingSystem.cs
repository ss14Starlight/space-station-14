...
public sealed partial class PipeDockingSystem : EntitySystem
{
    ...
    private void OnDocked(DockEvent ev)
    {
        ...
        GetDockConnectingPipes(ev.DockAUid, _dockAPipes);
        GetDockConnectingPipes(ev.DockBUid, _dockBPipes);
    ...
    {
        GetDockConnectingPipes(ev.DockAUid, _dockAPipes, includeDisabled: true);
        GetDockConnectingPipes(ev.DockBUid, _dockBPipes, includeDisabled: true);
