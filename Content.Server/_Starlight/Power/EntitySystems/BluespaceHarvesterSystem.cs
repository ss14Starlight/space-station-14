...
public sealed partial class BluespaceHarvesterSystem : EntitySystem
{
    ...
    private void TrySpawnPortal(EntityUid uid, BluespaceHarvesterComponent component, float frameTime)
    {
        ...
        var distance = _random.NextFloat(component.PortalMinDistance, (component.PortalMaxDistance * (levelsAboveThreshold + 1))); // Higher levels rapidly increase max portal distance
        ...
        var mobCount = _random.Next((component.MinMobsPerPortal * levelsAboveThreshold), (component.MaxMobsPerPortal * (levelsAboveThreshold + 1)) + 1); // Higher levels increase the number of Mobs
