...
public sealed partial class SurgerySystem : SharedSurgerySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<MultipleSurgeryToolComponent, AfterInteractEvent>(OnMultipleToolAfterInteract);
    ...
    private void OnMultipleToolAfterInteract(Entity<MultipleSurgeryToolComponent> ent, ref AfterInteractEvent args) => ProcessInteract(args);

    private void OnToolAfterInteract(Entity<SurgeryToolComponent> ent, ref AfterInteractEvent args) => ProcessInteract(args);

    private void ProcessInteract(AfterInteractEvent args)
    {
        var user = args.User;
        if (args.Handled ||
            !args.CanReach ||
