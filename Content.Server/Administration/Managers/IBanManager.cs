...
public interface IBanManager
{
    ...
    public bool IsRoleBanned(ICommonSession player, List<ProtoId<AntagPrototype>> antags); // Starlight, removed params
    ...
    /// <returns>Returns True if an active role ban is found for this player for any of the listed roles.</returns>
    public bool IsRoleBanned(ICommonSession player, List<ProtoId<JobPrototype>> jobs); // Starlight, removed params
