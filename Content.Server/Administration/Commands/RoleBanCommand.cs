...
public sealed class RoleBanCommand : IConsoleCommand
{
    ...
    public async void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        HashSet<string>? roles = new() { role }; // Starlight-edit
        ...
        if (_proto.HasIndex<JobPrototype>(role))
        {
            ...
            _bans.WebhookUpdateRoleBans(targetUid, located.Username, shell.Player?.UserId, null, targetHWid, roles, minutes, severity, reason, DateTimeOffset.UtcNow); // Starlight-edit
        }
