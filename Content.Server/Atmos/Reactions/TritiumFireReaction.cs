...
namespace Content.Server.Atmos.Reactions
{
    ...
    public sealed partial class TritiumFireReaction : IGasReactionEffect
    {
        public ReactionResult React(GasMixture mixture, IGasMixtureHolder? holder, AtmosphereSystem atmosphereSystem, float heatScale)
        {
            ...
            if (burnedFuel > 0)
            {
                energyReleased += ((Atmospherics.FireHydrogenEnergyReleased * 5f) * burnedFuel); /// Starlight: Trit burns hotter than regular hydrogen due to being "laced" with plasma. Counteracts other changes.
