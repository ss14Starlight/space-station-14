...
public sealed partial class AtmosphereSystem
{
    ...
    public void RebuildGridAtmosphere(Entity<GridAtmosphereComponent, MapGridComponent> ent)
    {
        ...
        // 9: Verdant outside atmosphere, matching the map atmosphere mix.
        mixtures[9].AdjustMoles(Gas.Oxygen, 5f);
        mixtures[9].AdjustMoles(Gas.Nitrogen, 5f);
        mixtures[9].AdjustMoles(Gas.CarbonDioxide, 100f);
        mixtures[9].Temperature = 288f;
