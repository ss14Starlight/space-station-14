...
public sealed partial class BorgMenu : FancyWindow
{
    ...
    private readonly BorgChassisResetSystem _chassisReset; // Starlight

    public Action? BrainButtonPressed;
    public Action? EjectBatteryButtonPressed;
    public Action? LockdownButtonPressed; // Starlight
    public Action? ResetChassisButtonPressed; // Starlight
    ...
    public BorgMenu()
    {
        ...
        _chassisReset = _entity.System<BorgChassisResetSystem>(); // Starlight
        ...
        LockdownButton.OnPressed += _ => LockdownButtonPressed?.Invoke(); // Starlight
        ResetChassisButton.OnPressed += _ => ResetChassisButtonPressed?.Invoke(); // Starlight
    ...
    public void SetEntity(EntityUid entity)
    {
        ...
        UpdateBrainButton();
        UpdateModulePanel();
        UpdateLockdownButton(); // Starlight
        UpdateResetChassisButton(); // Starlight
    }
