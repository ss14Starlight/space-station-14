...
public sealed class StyleStarlight : StyleBase
{
    ...
    public static readonly Color NanoGold = Color.FromHex("#5B8499");
    public static readonly Color GoodGreenFore = Color.FromHex("#31843E");
    public static readonly Color ConcerningOrangeFore = Color.FromHex("#A5762F");
    public static readonly Color DangerousRedFore = Color.FromHex("#931313");
    ...
    public static readonly Color ChatBackgroundColor = Color.FromHex("#141412DD");

    //Bwoink
    public const string StyleClassPinButtonPinned = "pinButtonPinned";
    public const string StyleClassPinButtonUnpinned = "pinButtonUnpinned";
    public override Stylesheet Stylesheet { get; }
    public StyleStarlight(IResourceCache resCache) : base(resCache)
    {
        var notoSans8 = resCache.NotoStack(size: 7);
        var notoSans10 = resCache.NotoStack(size: 8);
        var notoSansItalic10 = resCache.NotoStack(variation: "Italic", size: 8);
        var notoSans12 = resCache.NotoStack(size: 10);
        var notoSansItalic12 = resCache.NotoStack(variation: "Italic", size: 10);
        var notoSansBold12 = resCache.NotoStack(variation: "Bold", size: 10);
        var notoSansBoldItalic12 = resCache.NotoStack(variation: "BoldItalic", size: 10);
        var notoSansBoldItalic14 = resCache.NotoStack(variation: "BoldItalic", size: 12);
        var notoSansBoldItalic16 = resCache.NotoStack(variation: "BoldItalic", size: 14);
        var notoSansDisplayBold14 = resCache.NotoStack(variation: "Bold", display: true, size: 12);
        var notoSansDisplayBold16 = resCache.NotoStack(variation: "Bold", display: true, size: 14);
        var notoSans15 = resCache.NotoStack(variation: "Regular", size: 13);
        var notoSans16 = resCache.NotoStack(variation: "Regular", size: 14);
        var notoSansBold16 = resCache.NotoStack(variation: "Bold", size: 14);
        var notoSansBold18 = resCache.NotoStack(variation: "Bold", size: 16);
        var notoSansBold20 = resCache.NotoStack(variation: "Bold", size: 18);
        var notoSansMono = resCache.GetFont("/EngineFonts/NotoSans/NotoSansMono-Regular.ttf", size: 10);
        var windowHeaderTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/window_header.png");
        ...
        var windowHeaderAlertTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/window_header_alert.png");
        ...
        {
            Texture = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/window_background.png"),
            //Mode = StyleBoxTexture.StretchMode.Tile
        };
        windowBackground.SetPatchMargin(StyleBox.Margin.Horizontal | StyleBox.Margin.Bottom, 2);
        windowBackground.SetExpandMargin(StyleBox.Margin.Horizontal | StyleBox.Margin.Bottom, 2);

        var borderedWindowBackgroundTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/window_background_bordered.png");
        ...
        var borderedTransparentWindowBackgroundTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/transparent_window_background_bordered.png");
        ...
        var buttonRectTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/light_panel_background_bordered.png");
        ...
        var buttonRectActionMenuItemTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/black_panel_light_thin_border.png");
        var buttonRectActionMenuRevokedItemTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/black_panel_red_thin_border.png");
        ...
        var buttonTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/button.svg.96dpi.png");
        ...
        var chatChannelButtonTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/rounded_button.svg.96dpi.png");
        ...
        var chatFilterButtonTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/rounded_button_bordered.svg.96dpi.png");
        ...
        var smallButtonTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/button_small.svg.96dpi.png");
        var smallButtonBase = new StyleBoxTexture
        {
            Texture = smallButtonTex,
        };

        var textureInvertedTriangle = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/inverted_triangle.svg.png");

        var lineEditTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/lineedit.png");
        ...
        var actionSearchBoxTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/black_panel_dark_thin_border.png");
        ...
        var tabContainerPanelTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/tabcontainer_panel.png");
        ...
        // CheckBox
        var checkBoxTextureChecked = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/checkbox_checked.svg.96dpi.png");
        var checkBoxTextureUnchecked = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/checkbox_unchecked.svg.96dpi.png");

        // Tooltip box
        var tooltipTexture = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/tooltip.png");
        ...
        // Whisper box
        var whisperTexture = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/whisper.png");
        ...
        // Placeholder
        var placeholderTexture = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/placeholder.png");
        ...
        var squareTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/square.png");
        ...
        // Stripe background
        var stripeBackTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/stripeback.svg.96dpi.png");
        ...
        // Slider
        var sliderOutlineTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/slider_outline.svg.96dpi.png");
        var sliderFillTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/slider_fill.svg.96dpi.png");
        var sliderGrabTex = resCache.GetTexture("/Textures/_Starlight/Interface/Nano/slider_grabber.svg.96dpi.png");
...
// ListContainer
            ...
            Element<TextureButton>().Class(FancyWindow.StyleClassWindowHelpButton)
                .Prop(TextureButton.StylePropertyTexture, resCache.GetTexture("/Textures/_Starlight/Interface/Nano/help.png"))
            ...
            Element<TextureRect>().Class("NTLogoDark")
                .Prop(TextureRect.StylePropertyTexture, resCache.GetTexture("/Textures/_Starlight/Interface/Nano/ntlogo.svg.png"))
            ...
            Element<TextureButton>().Class("CrossButtonRed")
                .Prop(TextureButton.StylePropertyTexture, resCache.GetTexture("/Textures/_Starlight/Interface/Nano/cross.svg.png"))
