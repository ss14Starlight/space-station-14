...
public sealed partial class GhostThemeWindow : DefaultWindow
{
    ...
    public void ReloadGhostThemes()
    {
        ...
        foreach (var ghostTheme in _prototypeManager.EnumeratePrototypes<GhostThemePrototype>())
        {
            ...
            var toolTipText = string.Join(", ", ghostTheme.Requirements
            ...
            if (!string.IsNullOrWhiteSpace(toolTipText))
            {
                ...
                tooltip.SetMessage(FormattedMessage.FromMarkupPermissive(toolTipText));
                ghostPicker.TooltipSupplier = _ => tooltip;
            }
            else
            {
                ghostPicker.TooltipSupplier = null;
                ghostPicker.ToolTip = null;
            }
