...
public sealed partial class AnimationSyncSystem : EntitySystem
{
    ...
    private void OnAppearanceChanged(EntityUid uid, AnimationSyncComponent component, AppearanceChangeEvent args)
    {
        if (args.Sprite == null)
            return;
    ...
    private void UpdateLayerSync(EntityUid uid,
