...
public sealed partial class CharacterICInfoControl : Control
{
    ...
    public void SetCharacter(EntityUid? target, IEntityManager entityManager, EntityUid viewer)
    {
        ...
        desc = desc != null ? FormattedMessage.RemoveMarkupPermissive(desc) : string.Empty;
        CharacterDesc.SetMessage(desc);
        CharacterDesc.InvalidateMeasure();
        ...
        exploitableInfo = exploitableInfo != null ? FormattedMessage.RemoveMarkupPermissive(exploitableInfo) : string.Empty;
        ExploitableInfo.SetMessage(exploitableInfo);
        ExploitableInfo.InvalidateMeasure();
        ...
        secrets = secrets != null ? FormattedMessage.RemoveMarkupPermissive(secrets) : string.Empty;
        SecretsInfo.SetMessage(secrets);

        HiddenInfoSection.Visible = Exploitable.Visible || Secrets.Visible;
        HiddenInfoSection.InvalidateMeasure();
    }
