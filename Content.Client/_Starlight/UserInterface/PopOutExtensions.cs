...
public static class PopOutExtensions
{
    ...
    /// </summary>
    public static T CreatePopOutableWindow<T>(this BoundUserInterface bui) where T : Control, IPopOutWindow, new()
    {
        ...
        var uiSystem = IoCManager.Resolve<IEntityManager>().System<UserInterfaceSystem>();
