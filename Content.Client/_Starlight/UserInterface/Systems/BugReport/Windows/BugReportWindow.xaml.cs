...
namespace Content.Client._Starlight.UserInterface.Systems.BugReport.Windows;
...
public sealed partial class BugReportWindow : DefaultWindow
{
    ...
    public BugReportWindow()
    {
        ...
        _configSub = _cfg.SubscribeMultiple()
            .OnValueChanged(StarlightCCVars.EnablePlayerBugReports, x => _enablePlayerBugReports = x, true)
            .OnValueChanged(StarlightCCVars.MinimumPlaytimeInMinutesToEnableBugReports, x => _minimumPlaytimeBugReports = x, true)
            .OnValueChanged(StarlightCCVars.MinimumSecondsBetweenBugReports, x => _minimumTimeBetweenBugReports = x, true)
            .OnValueChanged(StarlightCCVars.MaximumBugReportsPerRound, x => _maximumBugReportsPerRound = x, true)
            .OnValueChanged(StarlightCCVars.MaximumBugReportTitleLength, x => _maximumBugReportTitleLength = x, true)
            .OnValueChanged(StarlightCCVars.MinimumBugReportTitleLength, x => _minimumBugReportTitleLength = x, true)
            .OnValueChanged(StarlightCCVars.MaximumBugReportDescriptionLength, x => _maximumBugReportDescriptionLength = x, true)
            .OnValueChanged(StarlightCCVars.MinimumBugReportDescriptionLength, x => _minimumBugReportDescriptionLength = x, true);
