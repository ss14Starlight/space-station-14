...
public sealed class PowerTransmissionLaserBoundUserInterface : BoundUserInterface
{
    ...
    protected override void Open()
    {
        ...
        _window.EnabledButton.OnPressed += _ =>
        {
            ...
            SendPredictedMessage(new PowerTransmissionLaserSetEnabledMessage(next));
        };

        _window.PowerApplied += mw => SendPredictedMessage(new PowerTransmissionLaserSetPowerMessage(mw));
    }
    ...
    protected override void UpdateState(BoundUserInterfaceState state)
    {
        ...
        if (_window == null || state is not PowerTransmissionLaserBoundUserInterfaceState cast)
            return;
