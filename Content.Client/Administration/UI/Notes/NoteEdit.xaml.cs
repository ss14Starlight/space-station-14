...
public sealed partial class NoteEdit : FancyWindow
{
    ...
    public event Action<int, NoteType, string, NoteSeverity?, bool, DateTime?, string?>? SubmitPressed;

    public NoteEdit(SharedAdminNote? note, string playerName, bool canCreate, bool canEdit, string? project)
    {
    ...
    private void OnSubmitButtonPressed(BaseButton.ButtonEventArgs args)
    {
        ...
        SubmitPressed?.Invoke(NoteId, NoteType, Rope.Collapse(NoteTextEdit.TextRope), NoteSeverity, IsSecret, ExpiryTime, Project);
