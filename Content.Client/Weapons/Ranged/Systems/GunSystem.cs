...
public sealed partial class GunSystem : SharedGunSystem
{
    ...
    private void OnHitscan(HitscanEvent ev)
    {
        ...
        //The real bullet speed is so high that the bullet isn’t visible at all. So, let's slow it down 4x.
        var bulletSpeed = hitscan.Speed / 4000;
        var delay = 0f;
    ...
    private void RenderBullet(NetCoordinates coordinates, Angle angle, ExtendedSpriteSpecifier sprite, float distance, float length, float delay)
    {
        ...
        Timer.Spawn((int)time, () => spriteComp.Visible = false);
            ...
            AnimationTracks =
                {
                    new AnimationTrackSpriteFlick()
                    {
                        ...
                        KeyFrames =
                        {
                            new AnimationTrackSpriteFlick.KeyFrame(rsi.RsiState, end? delay: time),
                        }
                    }
                }
        };
                ...
                KeyFrames =
                        {
                            ...
                            new AnimationTrackProperty.KeyFrame(new Vector2(distance, 0.5f), (time + 0.15f) / 1000),
                        },
                ...
                KeyFrames =
                        {
                            ...
                            new AnimationTrackProperty.KeyFrame(new Vector2(0, 0f), (time + 0.15f) / 1000),
                        },
                InterpolationMode = AnimationInterpolationMode.Cubic
            });
        }
