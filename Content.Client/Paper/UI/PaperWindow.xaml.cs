...
namespace Content.Client.Paper.UI
{
    ...
    public sealed partial class PaperWindow : BaseWindow
    {
        ...
        private Label _runtimeColorLabel = default!;
        private Button _runtimeColorBlackButton = default!;
        private Button _runtimeColorRedButton = default!;
        private Button _runtimeColorGreenButton = default!;
        private Button _runtimeColorBlueButton = default!;
        private Button _runtimeColorWhiteButton = default!;
        ...
        public PaperWindow()
        {
            ...
            Thickness1Button.OnPressed += _ => DrawingControl.LineThickness = 1f;
            Thickness2Button.OnPressed += _ => DrawingControl.LineThickness = 2f;
            Thickness3Button.OnPressed += _ => DrawingControl.LineThickness = 3f;
            Thickness4Button.OnPressed += _ => DrawingControl.LineThickness = 4f;
            Thickness5Button.OnPressed += _ => DrawingControl.LineThickness = 5f;
            ...
            CreateRuntimeColorControls();
        }

        private void CreateRuntimeColorControls()
        {
            _runtimeColorLabel = new Label { Text = "Color:" };
            _runtimeColorBlackButton = new Button { Text = "Black" };
            _runtimeColorRedButton = new Button { Text = "Red" };
            _runtimeColorGreenButton = new Button { Text = "Green" };
            _runtimeColorBlueButton = new Button { Text = "Blue" };
            _runtimeColorWhiteButton = new Button { Text = "White" };
            ...
            _runtimeColorGreenButton.OnPressed += _ => SetDrawColor(Color.Green, "00ff00");
            _runtimeColorBlueButton.OnPressed += _ => SetDrawColor(Color.Blue, "0000ff");
            ...
            ColorButtons.AddChild(_runtimeColorRedButton);
            ColorButtons.AddChild(_runtimeColorGreenButton);
            ColorButtons.AddChild(_runtimeColorBlueButton);
        ...
        private void SetDrawingMode(bool drawing)
        {
            ...
            if (!_drawMode)
                DrawingControl.EraserEnabled = false;
            ...
            ThicknessLabel.Visible = _drawMode;
            Thickness1Button.Visible = _drawMode;
            Thickness2Button.Visible = _drawMode;
            ...
            _runtimeColorLabel.Visible = _drawMode;
            _runtimeColorBlackButton.Visible = _drawMode;
            _runtimeColorRedButton.Visible = _drawMode;
            _runtimeColorGreenButton.Visible = _drawMode;
            _runtimeColorBlueButton.Visible = _drawMode;
        ...
        private void SetDrawColor(Color color, string hex)
        {
            DrawingControl.SetLineColor(color, hex);
            _runtimeHexColorInput.Text = hex;
        }

        private void SetEraserMode(bool enabled)
        {
            DrawingControl.EraserEnabled = enabled;

            // Disable color/thickness editing while erasing so it is clear which mode is active.
            _runtimeColorLabel.Visible = !enabled && _drawMode;
            _runtimeColorBlackButton.Visible = !enabled && _drawMode;
            _runtimeColorRedButton.Visible = !enabled && _drawMode;
            _runtimeColorGreenButton.Visible = !enabled && _drawMode;
            _runtimeColorBlueButton.Visible = !enabled && _drawMode;
        ...
        {
            var hex = _runtimeHexColorInput.Text.Trim();
            ...
            try
            {
                ...
                SetDrawColor(color, hex.ToLowerInvariant());
            }
            catch
            {
                // Invalid hex input. Ignore it.
            }
        }

        private async Task ExportSvgToFile()
        {
            var filters = new FileDialogFilters(new FileDialogFilters.Group("svg"));
            var file = await _fileDialogManager.SaveFile(filters);
