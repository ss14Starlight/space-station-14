...
using Content.Shared._Sol.CCVar; // Sol
...
public sealed partial class ChannelFilterPopup : Popup
{
    ...
    public ChannelFilterPopup()
    {
        ...
        // Sol-start
        AutoFillHighlightsCheckBox.Pressed = _cfg.GetCVar(CCVars.ChatAutoFillHighlights);
        HighlightSoundCheckBox.Pressed = _cfg.GetCVar(SolCCVars.ChatHighlightSound);
        AutoFillHighlightsCheckBox.OnToggled += OnAutoFillHighlightsToggled;
        HighlightSoundCheckBox.OnToggled += OnHighlightSoundToggled;
        // Sol-end
    ...
    // Sol-start
    private void OnAutoFillHighlightsToggled(ButtonToggledEventArgs args)
    {
        _cfg.SetCVar(CCVars.ChatAutoFillHighlights, args.Pressed);
        _cfg.SaveToFile();
    }

    private void OnHighlightSoundToggled(ButtonToggledEventArgs args)
    {
        _cfg.SetCVar(SolCCVars.ChatHighlightSound, args.Pressed);
        _cfg.SaveToFile();
    }
    // Sol-end
    // Starlight start
