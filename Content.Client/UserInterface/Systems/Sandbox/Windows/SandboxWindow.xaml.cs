...
public sealed partial class SandboxWindow : DefaultWindow
{
    ...
    public SandboxWindow()
    {
        ...
        _zoneSystem = _entManager.System<ZonePlacementSystem>(); // Starlight
    }
    ...
    protected override void Opened()
    {
        ...
        ShowZonesButton.Pressed = _zoneSystem.ShowZones; // Starlight
        ShowRoomsButton.Pressed = _zoneSystem.ShowRooms; // Starlight
